...
ArenaScoreTrackerFrame = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate")
local frame = ArenaScoreTrackerFrame 
frame:SetPoint("TOPLEFT")

frame.dragme = frame:CreateFontString(nil, "OVERLAY")
frame.dragme:SetFont("Fonts\\FRIZQT__.TTF", 5)
